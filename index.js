...
let firstThing = 'pizza';
let secondThing = 'pinapple'

if (secondThing === 'pinapple'){
  firstThing = 'steak'
} 
...
console.log('task 1 d:', multiply(2, 5));
...
console.log('task 3:', hungryDog(70, 5));
